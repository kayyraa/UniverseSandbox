...
SaveButton.addEventListener("click", () => {
    ...
    Array.from(Scene.children).forEach(Object => {
        const Physics = JSON.parse(Object.getAttribute("Physics"));
        const Style = Object.fromEntries(
            String(Object.getAttribute("style") || "").split(";").filter(Boolean).map(Property => {
